...
from layouts import (  # annotation_layout,; instruction_example_tabs,; tagging_layout,; popup_layout,; stat_layout,
    annotate_data_dir,
    example_tab_content,
...
# Callback for popup
@app.callback(Output("confirm", "displayed"), Input("choose-data", "value"))
...
@app.callback(
    ...
    [Input("annotate-next", "n_clicks"), Input("news-class", "value")],
